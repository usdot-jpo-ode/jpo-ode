...
@JsonSubTypes({
		@JsonSubTypes.Type(value = us.dot.its.jpo.ode.plugin.j2735.AddGrpB.NodeOffsetPointXY_addGrpBReg_NodeOffsetPointXY.class, name = "2")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = us.dot.its.jpo.ode.plugin.j2735.AddGrpB.NodeOffsetPointXY_addGrpBReg_NodeOffsetPointXY.class, intId = 2)})
