...
public class OssBsm {
    ...
    private OssBsm() {
        throw new IllegalAccessException("Static class cannot be instantiated");
    }
    ...
    public static BasicSafetyMessage basicSafetyMessage(J2735Bsm genericBsm) {
        ...
        basicSafetyMessage.coreData.accelSet = new AccelerationSet4Way(new Acceleration(0), new Acceleration(0),
                new VerticalAcceleration(0), new YawRate(0));
