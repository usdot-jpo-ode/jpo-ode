...
public class OssBsmCoreData {
    ...
    public static J2735BsmCoreData genericBsmCoreData(BSMcoreData coreData) {
        ...
        genericBsmCoreData.accuracy = OssPositionalAccuracy.genericPositionalAccuracy(coreData.accuracy);
        ...
        genericBsmCoreData.brakes = OssBrakeSystemStatus.genericBrakeSystemStatus(coreData.brakes);
        genericBsmCoreData.size = new OssVehicleSize(coreData.size).getGenericVehicleSize();
