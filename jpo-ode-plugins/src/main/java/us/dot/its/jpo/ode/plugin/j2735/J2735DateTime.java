...
public class J2735DateTime extends Asn1Object {
   ...
   public J2735DateTime() {
   }

   public J2735DateTime(Integer year, Integer month, Integer day, Integer hour,
   ...
   public J2735DateTime(DDateTime dDateTime) {
   ...
   public J2735DateTime(DFullTime dFullTime) {
      if (dFullTime != null) {
   ...
   public J2735DateTime(String dateTime) throws ParseException {
   ...
   public J2735DateTime setYear(Integer year) {
      this.year = year;
      return this;
   }
   ...
   public J2735DateTime setMonth(Integer month) {
      this.month = month;
      return this;
   }
   ...
   public J2735DateTime setDay(Integer day) {
      this.day = day;
      return this;
   }
   ...
   public J2735DateTime setHour(Integer hour) {
      this.hour = hour;
      return this;
   }
   ...
   public J2735DateTime setMinute(Integer minute) {
      this.minute = minute;
      return this;
   }
   ...
   public J2735DateTime setSecond(BigDecimal second) {
      this.second = second;
      return this;
   }
