...
public class RequestorTypeBuilder {
    ...
    public static J2735RequestorType genericRequestorType(JsonNode typeData) {
		...
		if(subrole != null)
		{
            J2735RequestSubRole enumSubrole = J2735RequestSubRole.valueOf(subrole.asText());
		...
		if(request != null)
		{
            J2735RequestImportanceLevel enumRequest = J2735RequestImportanceLevel.valueOf(request.asText());
