...
public class OssMessageId {

   private OssMessageId() {
   }

   public static J2735MessageId genericMessageId(MsgId msgId) {
      ...
      case MsgId.furtherInfoID_chosen:
         if (msgId.hasFurtherInfoID())
            messageId.setChosenField("furtherInfoID_chosen",
                  CodecUtils.toHex(msgId.getFurtherInfoID().byteArrayValue()));
         break;
      case MsgId.roadSignID_chosen:
         if (msgId.hasRoadSignID())
            messageId.setChosenField("roadSignID_chosen", OssRoadSignId.genericRoadSignId(msgId.getRoadSignID()));
         break;
      }
      return messageId;
   }
