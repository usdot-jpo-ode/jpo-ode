...
/**
 * -- Summary --
 * JUnit test class for OssSpeedandHeadingandThrottleConfidence
 * 
 * Verifies correct conversion from generic SpeedandHeadingandThrottleConfidence to
 * compliant-J2735SpeedandHeadingandThrottleConfidence
 * 
 * Independent variables for the tests are set to value 0
 * 
 * -- Documentation --
 * Data Frame: DF_SpeedHeadingThrottleConfidence
 * Use: The DF_SpeedHeadingThrottleConfidence data frame is a single data frame combining multiple related bit fields
 * into one concept.
 ...
 *       }
 *       
 * Data Element: DE_HeadingConfidence
 * Use: The DE_HeadingConfidence data element is used to provide the 95% confidence level for the currently reported
 * value of DE_Heading, taking into account the current calibration and precision of the sensor(s) used to measure 
 ...
 * a fault, the confidence interval should be increased accordingly. The frame of reference and axis of rotation used 
 ...
 *          
 * Data Element: DE_SpeedConfidence
 * Use: The DE_SpeedConfidence data element is used to provide the 95% confidence level for the currently reported
 * value of DE_Speed, taking into account the current calibration and precision of the sensor(s) used to measure 
 * and/or calculate the value. This data element is only to provide the listener with information on the limitations 
 * of the sensing system, not to support any type of automatic error correction or to imply a guaranteed maximum 
 * error. This data element should not be used for fault detection or diagnosis, but if a vehicle is able to detect 
 * a fault, the confidence interval should be increased accordingly. The frame of reference and axis of rotation used
 ...
 *       }
 *
 * Data Element: DE_ThrottleConfidence
 * Use: The DE_ThrottleConfidence data element is used to provide the 95% confidence level for the currently reported
 * value of DE_Throttle, taking into account the current calibration and precision of the sensor(s) used to measure 
 * and/or calculate the value. This data element is only to provide information on the limitations of the sensing 
 * system, not to support any type of automatic error correction or to imply a guaranteed maximum error. This data 
 * element should not be used for fault detection or diagnosis, but if a vehicle is able to detect a fault, the 
 * confidence interval should be increased accordingly. If a fault that triggers the MIL is of a nature to render 
 * throttle performance unreliable, then ThrottleConfidence should be represented as "notEquipped."
 * ASN.1 Representation:
...
public class OssSpeedandHeadingandThrottleConfidenceTest {
    ...
    public void shouldReturnUnavailableHeadingConfidence() {
        ...
        SpeedandHeadingandThrottleConfidence testshtc = new SpeedandHeadingandThrottleConfidence(
                testHeadingConfidence,
                testSpeedConfidence,
                testThrottleConfidence);
    ...
    public void shouldReturnMaximumHeadingConfidence() {
        ...
        SpeedandHeadingandThrottleConfidence testshtch = new SpeedandHeadingandThrottleConfidence(
                testHeadingConfidence,
                testSpeedConfidence,
                testThrottleConfidence);
    ...
    /**
     * Test that a heading confidence value (-1) below the lower bound (0) throws IllegalArgumentException
     */
    @Test
    ...
    /**
     * Test that a heading confidence value (8) above the upper bound (7) throws IllegalArgumentException
     */
    @Test
    ...
    /**
     * Test that the undefined speed confidence flag value (0) returns (unavailable)
     */
    @Test
    ...
    /**
     * Test that a speed confidence value (-1) below the lower bound (0) throws IllegalArgumentException
     */
    @Test
    ...
    /**
     * Test that a speed confidence value (8) above the upper bound (7) throws IllegalArgumentException
     */
    @Test
    ...
    /**
     * Test that the minimum throttle confidence value (1) returns (prec10percent)
     */
    @Test
    ...
    /**
     * Test that the maximum throttle confidence value (3) returns (prec0-5percent)
     */
    @Test
    ...
    /**
     * Test that a throttle confidence value (-1) below the lower bound (0) throws IllegalArgumentException
     */
    @Test
    ...
    /**
     * Test that a throttle confidence value (4) above the upper bound (3) throws IllegalArgumentException
     */
    @Test
