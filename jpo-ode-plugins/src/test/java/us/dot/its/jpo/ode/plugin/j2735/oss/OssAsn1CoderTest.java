...
public class OssAsn1CoderTest {
    ...
    public void testUPER_DecodeBsmHex() {
        ...
        assertEquals(expectedValue, coder.UPER_DecodeBsmHex(inputString).toJson(false));
    }
    ...
    public void testUPER_DecodeMessageFrameHex() {
        ...
        assertEquals(expectedValue, coder.UPER_DecodeMessageFrameHex(inputString).toJson(false));
