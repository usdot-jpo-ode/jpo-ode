...
public class UnavailableNumericFieldTest {
   ...
   public void test() throws EncodeFailedException, EncodeNotSupportedException {
      ...
      assertEquals(0, bsm.coreData.getSpeed().compareTo(BigDecimal.valueOf(0.2)));
      assertNull(bsm.coreData.getAngle());
...
//      bsm.coreData.angle = new SteeringWheelAngle(126);
      ...
      assertNull(bsm.coreData.getSpeed());
      assertEquals(0, bsm.coreData.getAngle().compareTo(BigDecimal.valueOf(189.0)));
   }
