...
/**
 * -- Summary --
 * JUnit test class for OssTransmissionandSpeed
 * 
 * Verifies correct conversion from generic TransmissionandSpeed to compliant-J2735TransmissionandSpeed
 * 
 * Velocity is an independent variable for these tests and is set to 0
 * 
 * Note: The speed/velocity element of this class is tested by OssSpeedandVelocityTest
 * 
 * -- Documentation --
 * Data Frame: DF_TransmissionAndSpeed
 * Use: The DF_TransmissionAndSpeed data frame expresses the speed of the vehicle and the state of the transmission.
 ...
 * Use: The DE_TransmissionState data element is used to provide the current state of the vehicle transmission.
 * ASN.1 Representation:
...
public class OssTransmissionAndSpeedTest {
    ...
    public void shouldReturnUnavailableTransmissionState() {
        ...
        TransmissionAndSpeed testTransmissionandSpeed = new TransmissionAndSpeed(
                testTransmissionState,
                testVelocity);
    ...
    /**
     * Test that a transmission state value (-1) below the lower bound (0) throws IllegalArgumentException
     */
    @Test
    ...
    /**
     * Test that a transmission state value (8) above the upper bound (7) throws IllegalArgumentException
     */
    @Test
