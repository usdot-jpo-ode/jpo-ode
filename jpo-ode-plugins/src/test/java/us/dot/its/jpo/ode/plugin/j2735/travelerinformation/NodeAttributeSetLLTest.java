...
public class NodeAttributeSetLLTest {
    ...
    public void testDeserializeJson_dWidth_dElevation() throws JsonProcessingException {
        final NodeAttributeSetLL nasll = mapper.readValue(DWITDH_DELEVATION_ONLY_JSON, NodeAttributeSetLL.class);
        assertNotNull(nasll);
    ...
    private final static String DWITDH_DELEVATION_ONLY_JSON = """
