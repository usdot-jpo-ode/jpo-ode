...
/**
 * -- Summary -- JUnit test class for OssFullPositionVector
 * 
...
public class OssFullPositionVectorTest {
   ...
   public void shouldReturnUndefinedLongitude() {
      ...
      BigDecimal actualValue = OssFullPositionVector.genericFullPositionVector(testFPV).getPosition().getLongitude();
   ...
   public void shouldThrowExceptionLongitudeBelowLowerBound() {
      ...
      try {
         OssFullPositionVector.genericFullPositionVector(testFPV).getPosition().getLongitude();
   ...
   public void shouldReturnUndefinedLatitude() {
      ...
      BigDecimal actualValue = OssFullPositionVector.genericFullPositionVector(testFPV).getPosition().getLatitude();
   ...
   public void shouldThrowExceptionLatitudeBelowLowerBound() {
      ...
      try {
         OssFullPositionVector.genericFullPositionVector(testFPV).getPosition().getLatitude();
         fail("Expected IllegalArgumentException");
      } catch (RuntimeException e) {
         assertEquals(IllegalArgumentException.class, e.getClass());
      }
   ...
   public void shouldReturnUndefinedElevation() {
      ...
      BigDecimal actualValue = OssFullPositionVector.genericFullPositionVector(testFPV).getPosition().getElevation();
   ...
   public void shouldThrowExceptionElevationBelowLowerBound() {
      ...
      try {
         OssFullPositionVector.genericFullPositionVector(testFPV).getPosition().getElevation();
         fail("Expected IllegalArgumentException");
      } catch (RuntimeException e) {
         assertEquals(IllegalArgumentException.class, e.getClass());
      }
   ...
   public void shouldReturnUnavailableTimeConfidence() {
      ...
      J2735TimeConfidence actualValue = OssFullPositionVector.genericFullPositionVector(testFPV).getTimeConfidence();
   ...
   public void shouldThrowExceptionTimeConfidenceBelowLowerBound() {
      ...
      try {
         OssFullPositionVector.genericFullPositionVector(testFPV).getTimeConfidence();
         fail("Expected IllegalArgumentException");
      } catch (RuntimeException e) {
         assertEquals(IllegalArgumentException.class, e.getClass());
      }
   ...
   public void testConstructorIsPrivate() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
     Constructor<OssFullPositionVector > constructor = OssFullPositionVector.class.getDeclaredConstructor();
