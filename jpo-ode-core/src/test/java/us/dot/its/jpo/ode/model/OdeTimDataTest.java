...
public class OdeTimDataTest {
  ...
  private static final String ASN1_STRING =
  ...
  public void shouldValidateJson() throws Exception {
    ...
    final JsonSchema schema = factory.getSchema(
        getClass().getClassLoader().getResource("schemas/schema-tim.json").toURI());
    ...
    assertEquals(String.format("Json validation errors: %s", validationMessages), 0,
