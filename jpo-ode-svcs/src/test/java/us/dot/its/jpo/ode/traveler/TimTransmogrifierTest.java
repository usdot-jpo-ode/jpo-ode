...
class TimTransmogrifierTest {
   ...
   @Test
   void testBuildASDNullTimeRethrowsTimeParsingExceptionFromSNMP() throws TimTransmogrifierException {
   ...
   @Test
   void testBuildASDNullTimeRethrowsTimeParsingExceptionFromSDW() throws TimTransmogrifierException {
   ...
   @Test
   void testConvertToXMLASD(@Capturing DateTimeUtils capturingDateTimeUtils,
      ...
      new MockUp<GeoRegionBuilder>() {
         @Mock
         DdsGeoRegion ddsGeoRegion(OdeGeoRegion serviceRegion) {
   ...
   @Test
   void testConvertToXMLMessageFrame(@Capturing DateTimeUtils capturingDateTimeUtils,
         @Capturing GeoRegionBuilder capturingGeoRegionBuilder)
         throws TimTransmogrifierException, JsonUtilsException, XmlUtilsException {
