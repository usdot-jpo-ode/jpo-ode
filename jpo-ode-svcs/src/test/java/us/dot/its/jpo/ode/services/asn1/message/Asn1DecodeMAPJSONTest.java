...
public class Asn1DecodeMAPJSONTest {
	@Mock
	Asn1DecodeMAPJSON testDecodeMapJson;
	...
	@Test
	public void testProcessMapJson() throws XmlUtilsException {

		testDecodeMapJson.process(json);
		when(testDecodeMapJson.process(json)).thenReturn(null);
		...
		doCallRealMethod().when(testDecodeMapJson).publishEncodedMessageToAsn1Decoder(obj);
