...
public class OdeTimDataCreatorHelperTest {
  @Test
    ...
    String xmlFilePath = "src/test/resources/us.dot.its.jpo.ode.coder/OdeTimDataCreatorHelper_TIM_XER.xml";
    ...
    String jsonFilePath = "src/test/resources/us.dot.its.jpo.ode.coder/OdeTimDataCreatorHelper_TIM_JSON.json";
