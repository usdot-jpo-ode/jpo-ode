...
class Asn1DecodeTIMJSONTest {
    ...
    void testConstructor() {
        ...
        assertEquals("topic.OdeRawEncodedTIMJson", properties.getKafkaTopicOdeRawEncodedTIMJson());
    }

    @Test
    void testProcess() throws JSONException {
        OdeProperties properties = new OdeProperties();
        Asn1DecodeTIMJSON testDecodeTimJson = new Asn1DecodeTIMJSON(properties, odeKafkaProperties);
