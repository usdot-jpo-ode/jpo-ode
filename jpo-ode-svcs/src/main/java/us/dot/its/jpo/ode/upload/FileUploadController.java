...
public class FileUploadController {
   ...
   public FileUploadController(
      ...
      threadPool.submit(new ImporterDirectoryWatcher(odeProperties, logPath, backupPath, failurePath, ImporterFileType.LEAR_LOG_FILE, odeProperties.getFileWatcherPeriod()));
