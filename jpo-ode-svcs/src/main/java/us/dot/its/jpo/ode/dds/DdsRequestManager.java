...
//            }
//         }   
         ddsClient = new DdsClient<T>(
               this.odeProperties.getDdsCasUrl(),
               this.odeProperties.getDdsCasUsername(),
               this.odeProperties.getDdsCasPassword(),
               this.odeProperties.getDdsWebsocketUrl(),
               null,
               null);
   ...
   public Session connect(
         WebSocketMessageHandler<T> messageHandler,
         Class<?> decoder) 
               throws DdsRequestManagerException {
      
      try {
         wsClient = ddsClient.login(
               (Class<? extends WebSocketMessageDecoder<T>>) decoder,
               messageHandler);
   ...
   protected abstract DdsRequest buildDdsRequest(OdeRequest odeRequest) 
         throws DdsRequestManagerException;
