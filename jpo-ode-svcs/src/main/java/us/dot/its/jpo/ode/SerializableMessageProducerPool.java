    ...
    public SerializableMessageProducerPool<K, V> init() {
        ...
        props.put("retries",
                odeProperties.getProperty("kafka.producer.retries", MessageProducer.DEFAULT_PRODUCER_RETRIES)); // If
                                                                                                                ...
                                                                                                                // can
        // automatically retry
        props.put("batch.size", odeProperties.getProperty("kafka.producer.batch.size",
                MessageProducer.DEFAULT_PRODUCER_BATCH_SIZE_BYTES));
        props.put("linger.ms",
        ...
        props.put("value.serializer", odeProperties.getProperty("kafka.value.serializer",
                MessageProducer.SERIALIZATION_BYTE_ARRAY_SERIALIZER));
