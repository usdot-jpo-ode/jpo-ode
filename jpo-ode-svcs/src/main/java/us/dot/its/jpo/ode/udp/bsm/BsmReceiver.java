...
public class BsmReceiver extends AbstractUdpReceiverPublisher {
  ...
  public BsmReceiver(ReceiverProperties receiverProperties, FfmlibDecodeService decodeService) {
  ...
  public void run() {
    ...
    do {
      try {
        ...
        log.error("Error decoding BSM packet", e);
      } catch (Exception e) {
        log.error("Error receiving BSM packet", e);
      }
    } while (!isStopped());
  }
}
